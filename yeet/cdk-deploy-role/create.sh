...
attach_policy "./policy/cloudformation.json" "$ROLE_NAME" "$ACCOUNT" "$REGION" "$EXTERNAL_ID"
attach_policy "./policy/kms.json" "$ROLE_NAME" "$ACCOUNT" "$REGION" "$EXTERNAL_ID"
attach_policy "./policy/s3.json" "$ROLE_NAME" "$ACCOUNT" "$REGION" "$(echo "$EXTERNAL_ID" | tr '[:upper:]' '[:lower:]')"
attach_policy "./policy/ssm.json" "$ROLE_NAME" "$ACCOUNT" "$REGION" "$EXTERNAL_ID"
attach_policy "./policy/sts.json" "$ROLE_NAME" "$ACCOUNT" "$REGION" "$EXTERNAL_ID"
